  ...
  try {
    ...
    if (data.type === 'order') {
      ...
      const orderData = {
        ...
        delivery_lat: orderPayload.delivery_lat || null,
        delivery_lng: orderPayload.delivery_lng || null,
        delivery_distance_km: orderPayload.delivery_distance_km || null,
        maps_link: orderPayload.maps_link || null,
        payment_method: 'upi',
        payment_status: 'paid',
        status: 'booked',
        price: data.amount,
